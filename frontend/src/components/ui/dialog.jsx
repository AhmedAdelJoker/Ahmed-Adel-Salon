    ...
    <DialogPortal>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-5 md:p-[4vh]">
        <DialogPrimitive.Content
          ref={ref}
          className={cn(
            "relative z-50 flex max-h-[min(92dvh,62rem)] w-[min(96vw,72rem)] max-w-[72rem] flex-col overflow-hidden rounded-[1.75rem] border border-border bg-white text-slate-900 shadow-premium duration-300 data-[state=open]:animate-in data-[state=open]:fade-in data-[state=open]:zoom-in-95 sm:rounded-[2.25rem] dark:border-slate-800/60 dark:bg-slate-950 dark:text-slate-50",
            className,
          )}
          {...props}
        >
