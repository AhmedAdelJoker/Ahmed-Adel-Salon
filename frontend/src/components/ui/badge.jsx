...
const badgeVariants = cva(
  "inline-flex w-fit shrink-0 items-center justify-center gap-1.5 overflow-hidden whitespace-nowrap rounded-xl border px-3 py-1 text-[10px] font-black uppercase tracking-widest transition-all [&>svg]:size-3",
  {
    variants: {
      variant: {
        default:
