...
export default function NotificationDrawer() {
  ...
  async function load(page = 1) {
    try {
      ...
      notify.error(err?.response?.data?.detail || "فشل تحميل الإشعارات");
    }
  }
  ...
  async function markAllRead() {
    try {
      ...
      notify.error(err?.response?.data?.detail || "فشل تحديث الإشعارات");
    }
  }
  ...
  async function toggleRead(item) {
    ...
    try {
      ...
      notify.error(err?.response?.data?.detail || "فشل تحديث الإشعار");
    }
  }
