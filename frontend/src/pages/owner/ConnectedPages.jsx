...
import { ExternalLink, Layers3, Settings2 } from "lucide-react";
import { Card, CardContent, CardHeader, CardTitle } from "../../components/ui/card";
import { Button } from "../../components/ui/button";

const GROUPS = [
  {
    title: "صفحات الإدارة المضافة",
    description: "صفحات كاملة كانت موجودة في المشروع لكنها غير موصولة بالراوتر.",
    items: [
      {
        title: "إعدادات المحل",
  ...
  {
    title: "صفحات إضافية مؤرشفة",
    description: "شاشات بديلة أو تجريبية تم توصيلها بمسارات مستقلة لمراجعتها بأمان.",
    items: [
      {
        title: "تقارير قديمة",
        to: "/owner/legacy-reports",
        note: "واجهة تقارير إضافية مع أدوات تصدير.",
      },
      {
        title: "الجدول",
        to: "/owner/legacy/schedule",
        note: "عرض جدولة بديل.",
      },
    ],
  },
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm font-bold text-gray-500 dark:text-gray-400">
                نقطة دخول سريعة لمراجعة الصفحات التي كانت موجودة في المشروع وغير مرتبطة بالتنقل.
              </p>
            </div>
          </div>
        </CardHeader>
        ...
        >
          ...
          <CardContent className="grid gap-4 md:grid-cols-2">
            {group.items.map((item) => (
              <div
                key={item.to}
                className="rounded-3xl border border-black/10 bg-gray-50/70 p-5 dark:border-white/10 dark:bg-white/5"
              >
