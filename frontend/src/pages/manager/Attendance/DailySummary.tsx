...
const statusConfig: Record<string, { label: string; color: string; textColor: string; bg: string; border: string; icon: React.ComponentType<{ size?: number | string; className?: string }> }> = {
  in: {
    label: "حضور",
