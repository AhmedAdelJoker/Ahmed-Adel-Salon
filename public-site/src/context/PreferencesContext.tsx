...
export function PreferencesProvider({ children }: { children: ReactNode }) {
  ...
  function resetPreferencesToDefault(): void {
  ...
  async function toggleTheme(): Promise<Preferences | null> {
  ...
  async function toggleLanguage(): Promise<Preferences | null> {
